...
public class ad_promotion {
 	...
 	private String adPicPath;//广告图片存储的路劲
	...
	public ad_promotion(Integer id, Integer appId, String adPicPath,
			Integer adPV, int carouselPosition, Date startTime, Date endTime,
